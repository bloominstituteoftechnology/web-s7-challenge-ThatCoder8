...
describe('Sprint 7 Challenge Learner Tests', () => {
  ...
  */
    ...
    test('sum(2, "seven") throws an error "pass valid number"', () => {
  ...
  */
 test('renders a link that ready "About"', () => {
  render(<HelloWorld />);
...
test('renders a text that includes "JavaSciprt is pretty" (use exact = false)', () => {
  render(<HelloWorld />);
